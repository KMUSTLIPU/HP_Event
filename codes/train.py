...
def test_on_block(model, cfg, blk,b=0):
    ...
    # if cfg.offline :
    #     print(f"save Evaluate_datas_offline to '{cfg.eva_data}/evaluate_data_offline.npy'", end='\t')
    #     np.save(f'{cfg.eva_data}/evaluate_data_offline.npy', Evaluate_datas)
    # else:
    #
...
if __name__ == "__main__":
    ...
    if config.offline:
        config.dataset = "/home/lipu/HP_event/cache_2012/offline.npy"
